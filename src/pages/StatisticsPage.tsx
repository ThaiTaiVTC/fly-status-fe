...
export default function StatisticsPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="container mx-auto px-6 py-8 space-y-8 pt-24">
        ...
        <ChartCard title="Doanh thu 6 tháng" description="Xu hướng doanh thu qua các tháng">
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={revenueData}>
              ...
              <YAxis stroke="hsl(var(--muted-foreground))" fontSize={12} domain={[0, 3600000]} tickFormatter={(value) => `${(value / 1000000).toFixed(1)}M`} />
              <Tooltip
                contentStyle={{
                  backgroundColor: "hsl(var(--card))",
                  border: "1px solid hsl(var(--border))",
              ...
              />
              <Line type="monotone" dataKey="revenue" stroke="hsl(var(--primary))" strokeWidth={3} dot={{ fill: "hsl(var(--primary))", strokeWidth: 2, r: 4 }} activeDot={{ r: 6, fill: "hsl(var(--primary))" }} />
            </LineChart>
          </ResponsiveContainer>
        </ChartCard>
        ...
        <ChartCard title="Gói dịch vụ" description="So sánh các gói dịch vụ">
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <Button variant={activeTab === "quantity" ? "primary" : "outline"} size="sm" onClick={() => setActiveTab("quantity")}>
                Số lượng
              </Button>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={packageData}>
                <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                <XAxis dataKey="package" stroke="hsl(var(--muted-foreground))" fontSize={12} />
                <YAxis
